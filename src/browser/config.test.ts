...
describe("browser config", () => {
  ...
  it("derives default ports from SARACLAW_GATEWAY_PORT when unset", () => {
    const prev = process.env.SARACLAW_GATEWAY_PORT;
    process.env.SARACLAW_GATEWAY_PORT = "19001";
    try {
      const resolved = resolveBrowserConfig(undefined);
      ...
      if (prev === undefined) {
        ...
        process.env.SARACLAW_GATEWAY_PORT = prev;
      }
    }
  });

...
import {
  ...
  DEFAULT_SARACLAW_BROWSER_ENABLED,
...
function normalizeHexColor(raw: string | undefined) {
  ...
  if (!value) {
    return DEFAULT_SARACLAW_BROWSER_COLOR;
  }
...
function ensureDefaultProfile(
  ...
  if (!result[DEFAULT_SARACLAW_BROWSER_PROFILE_NAME]) {
    result[DEFAULT_SARACLAW_BROWSER_PROFILE_NAME] = {
...
export function resolveBrowserConfig(
  ...
  const enabled = cfg?.enabled ?? DEFAULT_SARACLAW_BROWSER_ENABLED;

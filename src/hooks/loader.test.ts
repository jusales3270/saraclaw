...
describe("loader", () => {
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.SARACLAW_BUNDLED_HOOKS_DIR;
    process.env.SARACLAW_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      ...
      process.env.SARACLAW_BUNDLED_HOOKS_DIR = originalBundledDir;
    }

...
describe("getApiKeyForModel", () => {
  it("migrates legacy oauth.json into auth-profiles.json", async () => {
    ...
    try {
      process.env.SARACLAW_STATE_DIR = tempDir;
      process.env.SARACLAW_AGENT_DIR = path.join(tempDir, "agent");
      ...
      const store = ensureAuthProfileStore(process.env.SARACLAW_AGENT_DIR, {
